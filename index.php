...
?>
<div class="container">
 	<h1>Welcome to Covid Tele Health Clinic</h1>
    <p class="block-quote">We stand with everyone fighting on the frontlines</p>
  ...
  <?php 
    if(isset($_POST['lemail'])){
      ...
      echo "<div class='alert alert-info'>
              <strong>Info!</strong> Login/Register to take our covid-19 self assessment scan. We also provide the option to book an appointment with our team of doctors spread pan india.</div>";
    }
    unset($_POST);
  ?>
<div class="row">
